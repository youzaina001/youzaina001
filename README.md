...
Previously at **re:mind**, I helped optimize a SaaS data platform—reducing data access latency by **40 %**—and automated ML pipelines in the cloud.  
...
- Automated **ETL & standardization workflows** across heterogeneous biomedical sources  
- Designed **scalable architectures** ensuring data reproducibility & observability  
- Improved **data lineage tracking** and traceability across AI experiments  
...
- Developed and optimized **ETL pipelines** processing tens of GB daily  
- Automated workflows → **−40 % data access latency**  
- Deployed ML models in production via **Docker + CI/CD**  
- Designed **Azure / Databricks** architecture for scalability & efficiency  

---

### 🧮 **HPC Engineer – Eviden** (2023)
- Benchmarked AI workloads on CPU/GPU clusters  
- Built **Python automation tools** for benchmarking & reproducibility  
- Collaborated globally on performance R&D initiatives  
