...
- **[airflow-dq-agent](https://github.com/youzaina001/airflow-dq-agent)**: Airflow 3 data-quality workflow. Deterministic checks, allow-listed remediation, HITL apply. The model never writes SQL.
- **[GeoSpatial-data-pipeline](https://github.com/youzaina001/GeoSpatial-data-pipeline)**: Satellite scenes to a field-day table with polygon-masked NDVI. Python, DuckDB, Airflow. Runs locally: `uv sync && make run`.
